...
def thow_needle(needle_length, tile_seperation_distance):
    ...
    center_y = random.uniform(0, 0.5 * tile_seperation_distance)
    ...
    # Using sine here to understand if the needle and the line are touching/crossing.
    tip_y = center_y - (0.5 * needle_length) * math.sin(theta)
